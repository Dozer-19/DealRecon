...
The Android application ID stays `com.kenleposa.dealrecon`; debug builds continue using the existing release signing configuration and GitHub Actions secrets. Version code advances from 2 to 3 for an update build. Do not generate a replacement signing key.
...
4. Add Call Recon outcomes, DNC suppression, mail drafts, mail opt-out, reviewed mailing logs, campaigns, follow-up tasks, and lead-based conversion/ROI reporting. Manual workflows complete. No outbound automation is enabled.
